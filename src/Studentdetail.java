...
public class Studentdetail
{
    ...
    public static void main(String args[])
    {
        ...
        while(true)
        {
            System.out.println("\npress 1 to add detail");
            System.out.println("press 2 to delete detail");            
            System.out.println("press 3 to see information");
            System.out.println("press 4 to search specific information");
